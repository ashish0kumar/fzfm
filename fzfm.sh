...
[[ -n "$FZF_MEDIA_OPENER" ]] && MEDIA_OPENER="$FZF_MEDIA_OPENER"
[[ -n "$FZF_TEXT_EDITOR" ]] && TEXT_EDITOR="$FZF_TEXT_EDITOR"
[[ -n "$FZF_LIST_COMMAND" ]] && LIST_COMMAND="$FZF_LIST_COMMAND"
[[ -n "$FZF_PREVIEW_COMMAND" ]] && PREVIEW_COMMAND="$FZF_PREVIEW_COMMAND"
